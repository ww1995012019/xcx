...
Page({
  ...
  all_list: function (id) {
    var data = {};
    var that = this;
    console.log("12222222222")
    data.map = 'applet_sequence_size_trade';
    data.id = id;
    console.log(data.id)
    wx.request({
      url: app.globalData.requestUrl,
  ...
  requestDetail: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        //     })
        //   }
        console.log(res.data.data.id+"aid");
       

        that.all_list(res.data.data.id);
        that.setData({
          id: res.data.data.id
  ...
  addGoodNumOpera: function (id) {
    ...
    var goodsList = that.data.all_lists;
